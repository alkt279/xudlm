var rule = {
    ...
    timeout: 5000,
    class_name: '4K电影&4K电视剧&4K综艺&4K动漫&4K纪录片&4K教育&4K少儿',
    ...
    lazy: $js.toString(() => {
        try {
            ...
            // 创建代理IP池
            const proxyIps = [
                'http://154.12.55.106:80',
                'http://103.231.78.36:80',
                'http://45.95.147.105:8080',
                'http://103.156.249.52:80',
                'http://47.243.242.70:8080',
                'http://188.132.222.22:8080',
                'http://5.78.83.190:8080',
                'http://103.124.137.173:8080',
                'http://45.67.212.102:8080',
                'http://103.169.255.175:8080'
            ];
            
            // 定义四个解析接口（新增了指定的解析接口）
            const parseApis = [
               "http://shybot.top/v2/video/jx/?shykey=4595a71a4e7712568edcfa43949236b42fcfcb04997788ebe7984d6da2c6a51c&qn=max&url=",
...
"http://xiaobaibai.feng1210.top/小白白.php?url=",
    "http://140.210.9.53:8100/api/?key=02f19494ef5f87424353935de3e3f193&url=",
    "http://120.46.190.255/小白白.php?url=",          

            "http://103.163.47.120:7777/api/?key=yvgfYsmenad7cqm4b2&url=",
                "http://140.210.9.53:8100/api/?key=02f19494ef5f87424353935de3e3f193&url=",
                "http://sspa8.top:8100/api/?key=星艺影视&url=",
                "http://xn--ihqu10cn4c.xn--v4q818bf34b.xyz/api/yuyutx.php?flag=摸鱼测试&play=",
                "http://120.46.190.255/小白白.php?url="
            ];
            ...
            for (let api of parseApis) {
                try {
                    ...
                    const proxyIp = randomProxy.split('//')[1].split(':')[0];
