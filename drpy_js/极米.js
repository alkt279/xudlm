...
if (/\.m3u8$/.test(input)) {
    ...
    let kurl = 'http://yunhai.qijiyun.vip/home/api?type=ys&uid=43652&key=dfijmqtvxyCDLRTV01&url=' + encodeURIComponent(input);
...
`,
	...
	二级: $js.toString(() => {
		...
		VOD.vod_play_from = yg.length < 1 ? "不用扫码授权看4k画质,能不能看随缘🤣,是免费分享的,不能看不要抱怨,想要稳定就选🩸极速云4k🩸" : "不用扫码授权看4k画质,能不能看随缘🤣,是免费分享的,不能看不要抱怨,想要稳定就选🩸极速云4k🩸$$$4k 预告及花絮";
