...
"http://125.208.23.251:1314/lunxun/?url=",
"http://sspa8.top:8100/api/?cat_ext=eyJmbGFnIjpbInFxIiwi6IW+6K6vIiwicWl5aSIsIueIseWlh+iJuiIsIuWlh+iJuiIsInlvdWt1Iiwi5LyY6YW3Iiwic29odSIsIuaQnOeLkCIsImxldHYiLCLkuZDop4YiLCJtZ3R2Iiwi6IqS5p6cIiwidG5tYiIsInNldmVuIiwiYmlsaWJpbGkiLCIxOTA1Il0sImhlYWRlciI6eyJVc2VyLUFnZW50Ijoib2todHRwLzQuOS4xIn19&key=星睿4k&url=",
"https://kalbim.xatut.top/kalbim2025/781718/play/video_player.php?url=",
"http://125.208.23.251:1314/lunxun/?url=",
"http://111.92.242.214/jx2.php?url=",
"http://125.208.23.251:1314/lunxun/?url=",
"http://zhuimi.xn--v4q818bf34b.com/moyu/zhuimi?token=8FLHD0k2&url=",
"https://zhxy.eu.org/parse/Json解析合集?url=",
"http://103.163.47.120:7777/api/?key=yvgfYsmenad7cqm4b2&url=",
"http://zhuimi.xn--v4q818bf34b.com/moyu/zhuimi?token=85J64k5w&url="
...
globalThis.requestWithProxy = function(url, options, parseJson) {
    ...
    try {
        ...
        console.log("代理请求失败，使用直连: " + e.message);
        // 代理失败时使用直连
...
var rule = {
    ...
    lazy: $js.toString(() => {
      ...
      "http://125.208.23.251:1314/lunxun/?url="+ vid,
"http://sspa8.top:8100/api/?cat_ext=eyJmbGFnIjpbInFxIiwi6IW+6K6vIiwicWl5aSIsIueIseWlh+iJuiIsIuWlh+iJuiIsInlvdWt1Iiwi5LyY6YW3Iiwic29odSIsIuaQnOeLkCIsImxldHYiLCLkuZDop4YiLCJtZ3R2Iiwi6IqS5p6cIiwidG5tYiIsInNldmVuIiwiYmlsaWJpbGkiLCIxOTA1Il0sImhlYWRlciI6eyJVc2VyLUFnZW50Ijoib2todHRwLzQuOS4xIn19&key=星睿4k&url="+ vid,
"https://kalbim.xatut.top/kalbim2025/781718/play/video_player.php?url="+ vid,
"http://125.208.23.251:1314/lunxun/?url="+ vid,
"http://111.92.242.214/jx2.php?url="+ vid,
"http://125.208.23.251:1314/lunxun/?url="+ vid,
"http://zhuimi.xn--v4q818bf34b.com/moyu/zhuimi?token=8FLHD0k2&url="+ vid,
"https://zhxy.eu.org/parse/Json解析合集?url="+ vid,
"http://103.163.47.120:7777/api/?key=yvgfYsmenad7cqm4b2&url="+ vid,
"http://zhuimi.xn--v4q818bf34b.com/moyu/zhuimi?token=85J64k5w&url="+ vid,             "http://zhuimi.xn--v4q818bf34b.com/moyu/zhuimi?token=8FLHD0k2&url="+ vid,
            "http://103.163.47.120:7777/api/?key=yvgfYsmenad7cqm4b2&url=" + vid,
                "http://140.210.9.53:8100/api/?key=02f19494ef5f87424353935de3e3f193&url=" + vid,
                "http://sspa8.top:8100/api/?key=星艺影视&url=" + vid,
                "http://120.46.190.255/小白白.php?url=" + vid,
                "http://xn--ihqu10cn4c.xn--v4q818bf34b.xyz/api/yuyutx.php?flag=摸鱼测试&play=" + vid
            ];
            ...
            for (let i = 0; i < apis.length; i++) {
                try {
                    console.log("尝试解析接口 " + (i+1) + ": " + apis[i] + " 使用代理: " + getRandomProxy());
                    ...
                    if (data.url && data.url.includes("http")) {
                        if (data.url.startsWith("https://d.feiliupan.com/t/112641693848702976/IP使用次数超限，请加群签到.mp4") || 
                            data.url === "https://web.wya6.com/d/super/zhuimi/qfad.mp4" ||
                            data.url === "https://web.wya6.com/d/super/zhuimi/Anomaly.mp4") {
                    ...
                    try {
                        ...
                        let data = JSON.parse(response);
                        if (data.url && data.url.includes("http") && 
                            !data.url.startsWith("https://d.feiliupan.com/t/112641693848702976/IP使用次数超限，请加群签到.mp4") && 
                            data.url !== "https://web.wya6.com/d/super/zhuimi/qfad.mp4" &&
                            data.url !== "https://web.wya6.com/d/super/zhuimi/Anomaly.mp4") {
                            playUrl = data.url;
