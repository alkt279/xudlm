...
var rule = {
    ...
    lazy: $js.toString(() => {
        try {
            ...
            let apis = [
                "http://43.139.94.96:8866/api/?key=7e67ab331ee255664f2989ca2171c2dd&url=" + vid,
                "https://t2.qlplayer.cyou/player/analysis.php?v=" + vid,
            ...
            if (playUrl) {
                input = {
                    ...
                    url: playUrl,
                    jx: 0,
                    danmaku: 'http://127.0.0.1:9978/proxy?do=danmu&site=js&url=http://dm.qxq6.com/zy/api.php?url=' + vid
                };
            } else {
                input = {
                    header: {'User-Agent': ""},
